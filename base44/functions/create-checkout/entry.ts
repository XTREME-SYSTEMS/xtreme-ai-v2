...
Deno.serve(async (req: Request) => {
  try {
    ...
    const PRODUCTS: Record<string, { name: string; price: string; subscription?: { frequency: string } }> = {
      ...
      // ── Ingested Monthly Services (subscriptions) ──
      "monthly-ad-creative":           { name: "Monthly AI Ad Creative",            price: "149.00", subscription: { frequency: "MONTH" } },
      "monthly-email-sequence":         { name: "Monthly AI Email Sequences",       price: "99.00",  subscription: { frequency: "MONTH" } },
      "monthly-lead-scoring":          { name: "Monthly AI Lead Scoring",          price: "199.00", subscription: { frequency: "MONTH" } },
      "monthly-cro":                   { name: "Monthly AI CRO",                   price: "199.00", subscription: { frequency: "MONTH" } },
      "monthly-brand-voice":           { name: "Monthly AI Brand Voice",           price: "99.00",  subscription: { frequency: "MONTH" } },
      "monthly-repurpose":             { name: "Monthly AI Content Repurposing",   price: "149.00", subscription: { frequency: "MONTH" } },
      "monthly-schema":                { name: "Monthly AI Schema Markup",        price: "99.00",  subscription: { frequency: "MONTH" } },
      "monthly-internal-links":        { name: "Monthly AI Internal Linking",      price: "129.00", subscription: { frequency: "MONTH" } },
      "monthly-page-speed":            { name: "Monthly AI Page Speed",            price: "129.00", subscription: { frequency: "MONTH" } },
      "monthly-review-response":       { name: "Monthly AI Review Responses",      price: "99.00",  subscription: { frequency: "MONTH" } },
      "monthly-competitor-monitor":    { name: "Monthly AI Competitor Monitoring", price: "199.00", subscription: { frequency: "MONTH" } },
      "monthly-keyword-cluster":       { name: "Monthly AI Keyword Clustering",   price: "149.00", subscription: { frequency: "MONTH" } },
      "monthly-content-brief":         { name: "Monthly AI Content Briefs",       price: "149.00", subscription: { frequency: "MONTH" } },
      "monthly-social-listening":      { name: "Monthly AI Social Listening",      price: "179.00", subscription: { frequency: "MONTH" } },
      "monthly-predictive-analytics":  { name: "Monthly AI Predictive Analytics", price: "199.00", subscription: { frequency: "MONTH" } },
      "monthly-journey-map":           { name: "Monthly AI Customer Journey",     price: "149.00", subscription: { frequency: "MONTH" } },
      "monthly-ai-citation-tracking":  { name: "Monthly AI Citation Tracking",    price: "179.00", subscription: { frequency: "MONTH" } },
      "monthly-influencer-id":         { name: "Monthly AI Influencer ID",         price: "149.00", subscription: { frequency: "MONTH" } },
      "monthly-marketing-mix":         { name: "Monthly AI Marketing Mix",        price: "199.00", subscription: { frequency: "MONTH" } },
      ...
      // ── Ingested AI Tools (one-time) ──
      "ai-tool-ad-creative":     { name: "AI Ad Creative Generator",    price: "49.00" },
      "ai-tool-email-sequence":  { name: "AI Email Sequence Builder",   price: "49.00" },
      "ai-tool-lead-scoring":    { name: "AI Lead Scoring Engine",      price: "79.00" },
      "ai-tool-cro":             { name: "AI Conversion Rate Optimizer", price: "99.00" },
      "ai-tool-brand-voice":     { name: "AI Brand Voice Enforcer",      price: "39.00" },
      "ai-tool-repurpose":       { name: "AI Content Repurposing Engine", price: "59.00" },
      "ai-tool-schema":          { name: "AI Schema Markup Generator",  price: "49.00" },
      "ai-tool-internal-links":  { name: "AI Internal Linking Engine",  price: "69.00" },
      "ai-tool-page-speed":      { name: "AI Page Speed Optimizer",      price: "59.00" },
      "ai-tool-review-response": { name: "AI Review Response Generator",  price: "29.00" },
      "ai-tool-keyword-cluster": { name: "AI Keyword Clustering",        price: "69.00" },
      "ai-tool-content-brief":   { name: "AI Content Brief Generator",  price: "49.00" },
      "ai-tool-journey-map":     { name: "AI Customer Journey Mapping",  price: "89.00" },
      "ai-tool-influencer-id":   { name: "AI Influencer Identification", price: "79.00" },
