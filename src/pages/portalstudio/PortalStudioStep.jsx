    ...
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="rounded-xl border border-amber-400/30 bg-amber-400/5 p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs uppercase tracking-wider text-amber-400">Step {step.step} · Xtreme AI Build</p>
          </div>
          {isComplete && (
            <span className="ml-auto inline-flex items-center gap-1 rounded-md border border-amber-400/40 bg-amber-400/10 px-2 py-1 text-xs font-semibold text-amber-300">
      ...
      <div className="rounded-xl border border-white/10 bg-zinc-950 p-6">
        <div className="flex items-start gap-3">
          <Hammer className="h-5 w-5 shrink-0 text-amber-400" />
          <div>
            ...
            <p className="mt-1 text-sm text-white/60">
              ...
              (<code className="rounded bg-white/10 px-1 py-0.5 text-xs text-amber-300">{step.key}</code>)
        ...
        <button
          onClick={markDone}
          className="mt-5 inline-flex items-center gap-1.5 rounded-lg bg-amber-400 px-4 py-2.5 text-sm font-semibold text-black hover:bg-amber-300"
        >
