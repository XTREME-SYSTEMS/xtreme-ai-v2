                      ...
                      <>
                        <div className={cn(
                          ...
                          isActive || (isAutoBuilder && showAutoBuilderSub)
                            ? "border-amber-400 bg-amber-400 text-black shadow-[0_0_12px_2px_rgba(255,215,0,0.5)]"
                        ...
                        return (
                          ...
                          >
                            <div className={cn(
                              ...
                              subActive
                                ? "border-amber-400 bg-amber-400 text-black shadow-[0_0_8px_1px_rgba(255,215,0,0.4)]"
