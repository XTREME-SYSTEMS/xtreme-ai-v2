...
const FAQS = [
  { q: "Is there a free option?", a: "Yes — our Demo mode lets you experience the entire workflow end-to-end: build your brand, website, social media, and videos. When you're ready to finalize and export, choose a paid plan. No credit card required to start the demo." },
