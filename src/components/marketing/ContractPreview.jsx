          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5">
              ...
              <div className="rounded-xl border border-black/10 bg-zinc-50 p-4">
                <h3 className="text-sm font-bold uppercase tracking-wider text-amber-700">{service.name}</h3>
              ...
              {/* Agreement checkbox */}
              <label className="mt-5 flex cursor-pointer items-start gap-3 rounded-xl border-2 border-black/10 p-4 transition-colors hover:border-amber-400">
                <input
                  type="checkbox"
                  checked={agreed}
            ...
            <div className="flex items-center gap-3 border-t border-black/10 px-6 py-4">
              ...
              <button
                ...
                disabled={!agreed}
                className="flex-1 rounded-xl bg-amber-400 px-5 py-2.5 text-sm font-bold text-black transition-all hover:bg-amber-300 disabled:cursor-not-allowed disabled:bg-black/10 disabled:text-black/30"
              >
