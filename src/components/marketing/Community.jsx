...
const CARDS = [
  { icon: Users, title: "By Marketers, For Marketers", desc: "Xtreme AI was built and powered by marketers focused on the traditional issues marketing professionals face day to day. Once success was found, it was introduced to the market to help marketers face common challenges." },
  ...
  { icon: Network, title: "Network With Other Successful Marketers", desc: "Connect with other ambitious agency owners, entrepreneurs and marketing professionals who are scaling successful businesses with Xtreme AI." },
];
    ...
    <section id="about" className="bg-white py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mt-12 text-center">
          <Link to="/register" className="group inline-flex items-center gap-2 rounded-xl bg-amber-400 px-7 py-4 text-base font-bold text-black transition-all hover:bg-amber-300 hover:shadow-xl hover:shadow-amber-400/40">
