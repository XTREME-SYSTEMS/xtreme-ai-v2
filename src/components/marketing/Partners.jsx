    ...
    <section id="partners" className="bg-white py-20">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-10 text-center">
          <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-amber-400/15 px-3 py-1 text-xs font-semibold text-amber-700"><Link2 className="h-3.5 w-3.5" /> Strategic Partner Network</div>
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {partners.map((p, i) => (
            <motion.a
              ...
              className="group flex flex-col rounded-2xl border border-zinc-200 bg-white p-6 transition-all hover:border-amber-400 hover:shadow-xl hover:shadow-amber-400/10"
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-black text-amber-400"><ExternalLink className="h-5 w-5" /></div>
              <div className="text-[11px] font-semibold uppercase tracking-wider text-amber-600">{p.category}</div>
              <h3 className="mt-1 text-lg font-bold text-black">{p.name}</h3>
              <p className="mt-2 flex-1 text-sm text-zinc-600">{p.description}</p>
              <div className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-black group-hover:text-amber-600">
