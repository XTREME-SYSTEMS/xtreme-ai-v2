      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}
          ...
          <div className="relative grid gap-10 lg:grid-cols-2">
            <div>
              <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-amber-400/15 px-3 py-1 text-xs font-bold uppercase tracking-wider text-amber-400">Get In Touch</div>
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-start gap-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-amber-400"><MapPin className="h-5 w-5 text-black" /></div>
                ...
                <div className="flex items-start gap-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-amber-400"><Phone className="h-5 w-5 text-black" /></div>
                  <div><div className="text-sm font-semibold text-white">Phone</div><a href="tel:+17722090266" className="text-sm text-white/60 hover:text-amber-400">(772) 209-0266</a></div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-amber-400"><Calendar className="h-5 w-5 text-black" /></div>
            ...
            <div className="flex flex-col justify-center gap-4">
              <div className="rounded-2xl border border-white/15 bg-white/5 p-6">
                ...
                <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                  <Link to="/pricing" className="group inline-flex items-center justify-center gap-2 rounded-xl bg-amber-400 px-5 py-3 text-sm font-bold text-black transition-all hover:bg-amber-300">
              ...
              <div className="rounded-2xl border border-amber-400/30 bg-amber-400/10 p-6">
                <div className="text-sm font-semibold text-amber-400">Already a client?</div>
                ...
                <Link to="/client-portal" className="mt-3 inline-flex items-center gap-1.5 text-sm font-bold text-amber-400 hover:text-amber-300">Go to Dashboard <ArrowRight className="h-4 w-4" /></Link>
              </div>
            </div>
          </div>
        </motion.div>
