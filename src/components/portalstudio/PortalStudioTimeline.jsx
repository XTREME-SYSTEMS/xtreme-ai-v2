                ...
                <span
                  className={cn(
                    ...
                    isCurrent
                      ...
                      : "border-white/15 bg-zinc-900 text-white/40 hover:border-yellow-300/40 hover:text-yellow-300"
                  )}
                >
                  <Icon className="h-4 w-4" />
                </span>
                <span className={cn("hidden whitespace-nowrap text-[11px] font-medium sm:block", isCurrent ? "text-yellow-300" : "text-white/30")}>
                  {step.label}
                </span>
              </button>
              {i < visibleSteps.length - 1 && (
                <div className={cn("mx-0.5 h-0.5 w-3 shrink-0 rounded-full sm:mx-1 sm:w-5", i < currentIdx ? "bg-yellow-300" : "bg-white/10")} />
              )}
            </div>
          );
        })}
