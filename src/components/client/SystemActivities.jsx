import {
  Building2, Globe, Palette, Monitor, Megaphone, Video, Search,
  Radar, Database, Rocket, FileText, Users, BarChart3, Box,
  Cpu, ShoppingCart, Network, ShieldCheck, TrendingUp,
} from "lucide-react";

// All possible activities the Xtreme AI Business Generator can perform.
// Shown on the Welcome step to orient the user on the full scope of the system.
            ...
            >
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-bold text-lime-400/60">{String(i + 1).padStart(2, "0")}</span>
