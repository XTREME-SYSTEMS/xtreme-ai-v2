...
import { ShieldCheck, ArrowRight, HardDrive, Github, Database, Cloud, Globe, TrendingUp, CheckCircle2, Loader2 } from "lucide-react";
        ...
        <div className="rounded-xl border border-white/10 bg-zinc-950 p-4">
          ...
          <div className="text-xs mt-1">
            {project?.domain_purchased ? (
              ...
              <span className="text-amber-400 flex items-center gap-1"><Loader2 className="h-3 w-3" /> {domainStatus.replace(/_/g, " ")}</span>
            ) : (
      ...
      {provisioning && (
        <div className="flex items-center gap-3 rounded-lg border border-lime-400/30 bg-lime-400/5 px-4 py-3">
          ...
          <div>
            ...
            <div className="text-xs text-white/50">Building site files, creating Drive/Git/Supabase/Vercel, buying domain, filling SEO/AEO gaps, creating Rank Engine campaign. This takes 1-3 minutes.</div>
          </div>
        </div>
      )}
    </div>
