import {
  Package, Building2, Palette, FileSignature, ShieldCheck, Rocket, Settings, LayoutDashboard,
} from "lucide-react";
...
export const CLIENT_STEPS = [
  ...
  },
  {
    ...
    nextLabel: "Go to Design Direction",
  ...
  },
  {
    ...
    step: 3,
    gate: "design",
    activityLabel: "Pick your design direction",
    title: "Step 3 · Pick Your Design Direction",
    body: "Below are 10 logo & web design packs in different colors and styles. Pick up to 3 that feel right for your epoxy business. Your choices tell our team exactly what you like — so we can design a site that matches your taste.",
  ...
  },
  {
    ...
    title: "Step 4 · Sign Your Service Agreement",
  ...
  },
  {
    ...
    title: "Step 5 · Approve Your Website Design",
  ...
  },
  {
    ...
    title: "Step 6 · Your Website Is Launching",
